...
- Historical upstream pages may continue to contain typographic Unicode such as smart quotes in prose. This is lower priority than invisible whitespace or UI residue because it does not usually break agent execution, but it remains a possible future normalization target if consistency needs to be tightened further.
