...
Open `configuration_workflows.md` for deeper configuration editing patterns, `query_automation.md` for headless extraction details, `release_workflows.md` when the workspace has not been acquired yet, and `workspace_layouts.md` when the user provides real paths.
