...
- Source provenance: inherited from `v3.2` because `v4.3` links to this page but its authoring tree does not contain a version-local copy
- Note: Referenced from `v4.3` as `Cycle-breaking-in-GCAM.md`.
