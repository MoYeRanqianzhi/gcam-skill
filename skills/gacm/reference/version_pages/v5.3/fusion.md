...
[filter step](dev-guide/examples.md#filterstep-objects) may contain a data name and a filter . Each
[filter](dev-guide/examples.md#filter-objects) contains a [predicate](dev-guide/examples.md#predicates) and the predicate
value.
