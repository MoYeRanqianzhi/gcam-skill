...
| :--- | :--- | :--- | :--- |
| Historical energy supply (used for calibration) | By region, fuel, flow, and year | EJ/yr | [Exogenous](inputs_supply.md) |
| Resource supply curves | By region, resource, and grade | EJ and 1975$/GJ | [Exogenous](inputs_supply.md) |
| Technology costs | By region, technology, and year | 1975$/GJ | [Exogenous](inputs_supply.md) |
| Logit exponents | By region and sector or subsector | unitless | [Exogenous](inputs_supply.md) |
| Share weight interpolation rules | By region, technology or subsector, and year | unitless | [Exogenous](inputs_supply.md) |
| Efficiency or input-output coefficient | By region, technology or subsector, and year | unitless | [Exogenous](inputs_supply.md) |
...
In general, the costs of producing electricity from renewable energy forms consist of the sum of the resource costs described here, the technology costs, and in some cases, backup-related costs. The latter two components to the costs are documented in the [electricity sector](supply_energy.md#electricity).

##### Wind

All regions are assigned a onshore wind and offshore wind energy supply curves, where the quantity is in exajoules (EJ) of electricity produced per year, and the price is in 1975$ per gigajoule (GJ) of electricity produced. Unlike fossil resources, uranium, or biomass, the quantities of wind energy are considered to be within "regional" markets; they can not be traded between the different modeled geopolitical regions. The [supply curves](details_energy.md#wind) in each region are derived from bottom-up analysis documented in [Eurek et al. (2017)](supply_energy.md#eurek2017). Note that in this supply curve formulation, the price is zero when the quantity is zero; these include factors such as reduced capacity factors, and water depth for offshore wind. Region-specific grid connection costs are derived from data on wind resource distance to grid, also from [Eurek et al. (2017)](supply_energy.md#eurek2017). The remainder of the costs of wind electricity generation are in the technology and backup, described in the [electricity sector](supply_energy.md#electricity).
...
Broadly, the energy transformation sectors in GCAM consist of all supplysectors between the [primary energy resources](supply_energy.md#resources) and the [final energy demands](demand_energy.md). The main energy transformation sectors highlighted in this documentation are [electricity](supply_energy.md#electricity), [refining](supply_energy.md#refining), [gas processing](supply_energy.md#en_gas_processing), [hydrogen production](supply_energy.md#hydrogen), and [district services](supply_energy.md#district-services). For more details, see [energy transformation](details_energy.md#energy-transformation)
...
Users can also include [energy intensity standards](policies_examples.md#res), such as a renewable energy standard.
