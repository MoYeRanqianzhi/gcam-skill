...
<font size="-1">
<a name="table_footnote">1</a>: A full list of gases included in GCAM is provided on the <a href="emissions.md#iamc-reference-card">emissions page</a>.  <br/>
...
<a name="table_footnote">3</a>: Emissions are reported at the regional resolution of the sector. See <a href="common_assumptions.md#regional-resolution">Regional Resolution</a>      <br/>
