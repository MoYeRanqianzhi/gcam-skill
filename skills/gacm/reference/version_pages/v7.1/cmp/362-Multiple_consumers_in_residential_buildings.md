# 362-Multiple consumers in residential buildings

Bundled CMP trace page for GCAM `v7.1`.

- Coverage mode: `cmp trace page`
- Source root: `gcam-doc/v7.1`
- Original linked asset: `cmp/362-Multiple_consumers_in_residential_buildings.pdf`
...
## Source Trace
- `cmp/362-Multiple_consumers_in_residential_buildings.pdf`
