...
Shares of feed are determined by a [logit sharing approach](choice.md), which depends on the relative costs of the different feed options. Demand for feed is determined by the scale of livestock demand and these feed shares
