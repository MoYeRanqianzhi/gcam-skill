...
| :--- | :--- | :--- | :--- |
| Land use and land cover | By GLU, land type, and year | thousand $$km^2$$ | [Land Allocator](land.md) |
| Historical harvested area (used to calculate historical yield) | By GLU, crop, management practice, and year | thousand $$km^2$$ | [Exogenous](inputs_supply.md) |
| Historical production (used to calculate historical yield) | By GLU, crop, management practice, and year | thousand $$km^2$$ | [Exogenous](inputs_supply.md) |
| Agriculture productivity growth (used to calculate future yield) | By GLU, crop, management practice, year | % per year | [Exogenous](inputs_supply.md) |
| Non-fertilizer, non-water, non-land variable cost of production | By GLU, crop, management practice, and year | 1975$/kg | [Exogenous](inputs_supply.md)  |
| Fertilizer coefficients | By GLU, crop, management practice, and year | 1975$/kg | [Exogenous](inputs_supply.md)  |
| Water coefficients | By GLU, crop, management practice, and year | 1975$/kg | [Exogenous](inputs_demand.md)  |
| Commodity prices | By region, commodity, and year | 1975$/kg | [Marketplace](marketplace.md)  |
...
where $$yield$$ is the yield for the technology and $$land$$ is the land allocation (retrieved from the [land allocation module](land.md)).
...
GCAM uses one of [two different logit formulations](choice.md#the-logit) to calculate the shares for each technology or subsector. For livestock, subsectors represent different production systems, where technologies represent different feed sources.
...
* Land constraints: GCAM users can constrain the amount of land of a particular type in a given region. Under such a policy, GCAM will calculate the tax or subsidy required to ensure that the constraint is met. See [example](policies_examples.md#land-constraint).
