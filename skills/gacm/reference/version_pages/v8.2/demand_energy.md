...
| :--- | :--- | :--- | :--- |
| Historical energy demand (used for calibration) | By region, technology, and year | EJ/yr | [Exogenous](inputs_demand.md) |
| Historical service demand (used for calibration) | By region, technology, service, and year | EJ/yr | [Exogenous](inputs_demand.md) |
| Historical floorspace demand (used for calibration) | By region and year | BM2/yr | [Exogenous](inputs_demand.md) |
| Cost | By region, technology, and year | 1975$/GJ | [Exogenous](inputs_demand.md) |
| Income and price elasticity | By region, demand, and year | unitless | [Exogenous](inputs_demand.md) |
| Residential floorspace demand parameters | By region | unitless | [Exogenous](inputs_demand.md) |
| Thermal load parameters | By region | various| [Exogenous](inputs_demand.md) |
| Satiation levels | By region and building type / service | m2/pers and EJ/pers | [Exogenous](inputs_demand.md) |
...
| Subregional income distribution| By region and year | shares| [Economy](economy.md) |
| Habitable Land | By region and year | thousand km2 | [Land](land.md) |
| Commodity prices | By region, commodity, and year | 1975$/GJ | [Marketplace](marketplace.md) |
| Logit exponents | By region and sector or subsector | unitless | [Exogenous](inputs_demand.md) |
| Share weight interpolation rules | By region, technology or subsector, and year | unitless | [Exogenous](inputs_demand.md) |
| Fuel preference elasticity | By region, technology or subsector, and year | unitless | [Exogenous](inputs_demand.md) |
| Energy intensities of EFW processes (desalination, abstraction, treatment, distribution, wastewater treatment) | Global | GJ per $$m^3$$ | [Exogenous](inputs_demand.md) |
| Irrigation water withdrawals | By region, GLU, crop, and year | $$km^3$$ per year | [GCAM water demand](demand_water.md) |
| Municipal water withdrawals | By region and year | $$km^3$$ per year | [Water demand module](demand_water.md) |
| Industrial water withdrawals | By region and year | $$km^3$$ per year | [Water demand module](demand_water.md) |
| Desalinated water production | By region and year | $$km^3$$ per year | [Water supply module](supply_water.md) |
...
The approach to modeling transportation in GCAM has been documented in [Kim et al. 2006](demand_energy.md#kim2006), [Kyle and Kim 2011](demand_energy.md#kyle2011), and the dataset in the current version of GCAM is documented in [Mishra et al. 2013](demand_energy.md#mishra2013). The modeling approach is consistent with the other sectors in the model, though with several different functional forms, and a higher level of detail than is found in the other sectors of the model.

#### System Boundaries and Structure

The transportation sector in GCAM is subdivided into four final demands: long-distance passenger air travel, (other) passenger travel, international freight shipping, and (other) freight. The transportation sector excludes energy consumption and materials moved via pipeline transport (but see [gas supply system](supply_energy.md#gas-processing)). Energy used by mobile mining, agricultural, industrial, and construction equipment is similarly not considered as transportation energy use, unless used on roadways and for the primary purpose of moving passengers and/or freight.
...
#### System boundaries
The specific system boundaries are explained in [Kyle et al. (2016)](demand_energy.md#kyle2016), and are set so as to include all energy for activities whose primary output is water, and to exclude from this domain production technologies that use both energy and water as inputs to produce some other good. For example, in thermoelectric power generation, energy is applied to water, and several studies of energy-for-water (e.g., [Sanders and Webber 2012](demand_energy.md#sanders2012)) have included it. This is not represented in GCAM as an "energy-for-water" process; rather, GCAM's representation of thermoelectric power generation consists of technologies that consume inputs of energy and water, and produce electricity as an output. The system boundaries of "energy-for-water" (EFW) consist of the following activities:
...
The modeling approach is documented in [Kyle et al. (2021)](demand_energy.md#kyle2021), and consists of the following steps:
