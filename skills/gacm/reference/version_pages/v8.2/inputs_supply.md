...
Image reference: html-image (gcam-figs/inputs_supply_faostat_foodcalories.png)<br/>
Mapping between FAO and GCAM primary (land-based) commodities (A) and count of FAO commodities per GCAM commodity (B)
{: .fig}

Image reference: html-image (gcam-figs/inputs_supply_faostat_harvestarea.png)<br/>
...
Image reference: html-image (gcam-figs/AgStorageData.jpg)<br/>
