...
| CO<sub>2</sub> Sequestration<sup>[6](#table_footnote)</sup> |  Technology, Region<sup>[3](#table_footnote)</sup>, and Year | MtC / year  | <a name="CO2 sequestration by tech"></a>CO<sub>2</sub> sequestration by tech | `emissions-sequestered` |
