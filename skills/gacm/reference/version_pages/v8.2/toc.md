...
* Inputs
	...
	- [Economy](inputs_economy.md)
	- [Land](inputs_land.md)
	- [Supply](inputs_supply.md)
* [Economy](economy.md)
* [Land](land.md)
* [Marketplace](marketplace.md)
* Supply
	- [Energy](supply_energy.md)
	- [Water](supply_water.md)
	- [Land](supply_land.md)
* Demand
	- [Energy](demand_energy.md)
	- [Water](demand_water.md)
	- [Land](demand_land.md)
* [Emissions](emissions.md)
* Outputs
	- [Emissions](outputs_emissions.md)
	- [Land](outputs_land.md)
	- [Prices](outputs_prices.md)
	- [Quantity](outputs_quantity.md)
	- [Trade](outputs_trade.md)
* Additional Details
	- [Emissions](details_emissions.md)
	- [Energy](details_energy.md)
	- [Inputs](details_inputs.md)
...
* Additional information:
  ...
  - [Common Assumptions](common_assumptions.md)
  - [Shared-Socioeconomic Pathways](ssp.md)
